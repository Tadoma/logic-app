This is a test task for LogicLike.
...
With Metro running, open a new terminal window/pane from the root of React Native project, and use one of the following commands to build and run Android or iOS app:
